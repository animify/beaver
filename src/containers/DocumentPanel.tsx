...
interface IDispatchProps {
    changeBoard: (id: string, models: Models) => void;
}

type Props = IStateProps & IDispatchProps;

class DocumentPanel extends React.PureComponent<Props> {
    public render() {
...
const mapDispatchToProps = (dispatch: Dispatch) => bindActionCreators({ changeBoard: setEntities }, dispatch) as IDispatchProps;
